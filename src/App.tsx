          ...
          <section className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-32">
            ...
            <div id="partner-section" className="lg:pl-8 relative">
              ...
              <div className="relative bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] rounded-2xl p-8 border border-[#d4af37]/20 shadow-2xl shadow-[#d4af37]/10 hover:shadow-[#d4af37]/20 transition-all duration-500">
                ...
                <div className="bg-[#0a0a0a]/80 rounded-xl border border-[#d4af37]/10 overflow-hidden" style={{ height: '513px' }}>
...
function ValueCard({
  ...
  return (
    <div className="group relative bg-gradient-to-br from-[#202020] to-[#2a2a2a] rounded-xl p-8 border border-[#d4af37]/10 hover:border-[#d4af37]/30 transition-all duration-500 hover:shadow-xl hover:shadow-[#d4af37]/10 hover:-translate-y-1">
      ...
      <div className="relative space-y-4">
        <div className="flex items-start space-x-4">
          <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#d4af37]/20 flex items-center justify-center group-hover:bg-[#d4af37]/30 transition-colors duration-300">
            <Icon className="w-6 h-6 text-[#d4af37]" />
          </div>
          <div className="flex-1">
            <h3 className="text-xl font-semibold mb-3 text-[#F8F8F8] group-hover:text-[#d4af37] transition-colors duration-300">
              {title}
            </h3>
            <p className="text-[#E5E5E5] leading-relaxed">
              {description}
